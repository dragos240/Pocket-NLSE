...
static FILE* screen_open_resource(const char* path) {
	u32 realPathSize = strlen(path) + 8;
	char realPath[realPathSize];

	snprintf(realPath, realPathSize, "%s", path);
...
void screen_init() {
	...
	screen_load_texture_file(TEXTURE_TOP_SCREEN_BG, "romfs:/top_screen_bg.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_BG, "romfs:/bottom_screen_bg.png", true);
	screen_load_texture_file(TEXTURE_TOP_SCREEN_TOP_BAR, "romfs:/top_screen_top_bar.png", true);
	screen_load_texture_file(TEXTURE_TOP_SCREEN_TOP_BAR_SHADOW, "romfs:/top_screen_top_bar_shadow.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_TOP_BAR, "romfs:/bottom_screen_top_bar.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_TOP_BAR_SHADOW, "romfs:/bottom_screen_top_bar_shadow.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_BOTTOM_BAR, "romfs:/bottom_screen_bottom_bar.png", true);
	screen_load_texture_file(TEXTURE_BOTTOM_SCREEN_BOTTOM_BAR_SHADOW, "romfs:/bottom_screen_bottom_bar_shadow.png", true);
	screen_load_texture_file(TEXTURE_LOGO, "romfs:/logo.png", true);
	screen_load_texture_file(TEXTURE_SCROLL_BAR, "romfs:/scroll_bar.png", true);
	screen_load_texture_file(TEXTURE_SELECTION_OVERLAY, "romfs:/selection_overlay.png", true);
	screen_load_texture_file(TEXTURE_BUTTON_SMALL, "romfs:/button_small.png", true);
	screen_load_texture_file(TEXTURE_BUTTON_LARGE, "romfs:/button_large.png", true);
	screen_load_texture_file(TEXTURE_POCKETS, "romfs:/pockets.png", true);
	screen_load_texture_file(TEXTURE_ITEM_OCCUPIED, "romfs:/itemOccupied.png", true);
	screen_load_texture_file(TEXTURE_MAP_BACK, "romfs:/map_back.png", true);
}
